...
def main(unused_argv):
  ...
  print([FLAGS.train_image_dir,FLAGS.val_image_dir,FLAGS.train_annotations_file, FLAGS.val_annotations_file])
  print([os.path.exists(FLAGS.train_image_dir), os.path.exists(FLAGS.val_image_dir), os.path.exists(FLAGS.train_annotations_file), os.path.exists(FLAGS.val_annotations_file)])
